        ...
        <div className="">
            <div>
                <div className="relative ">
                    ...
                    {/* For md screen size */}
                    {/* For large screens */}
                    <div className="dark:bg-gray-900 bg-gray-300 px-6 py-9">
                        <div className="container mx-auto flex items-center justify-between">
                            <h1 className="md:w-2/12 text-2xl font-medium font-serif cursor-pointer text-gray-800 dark:text-white" >
                               Shipping Box
                            </h1>
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                <li>
                                    <Link to={""}  className="dark:text-white py-2 px-2  text-base text-blackfocus:outline-none focus:ring-1 focus:ring-gray-300  hover:bg-gray-200 border-none rounded-lg">
                                        Home
                                    </Link>
                                </li>
                                <li>
                                    <Link to='/form' className="dark:text-white py-2 px-2  text-base text-blackfocus:outline-none focus:ring-1 focus:ring-gray-300  hover:bg-gray-200 border-none rounded-lg">
                                        Form
                                    </Link>
                                </li>
                                <li>
                                    <Link to='/table' className="dark:text-white py-2 px-2  text-base text-blackfocus:outline-none focus:ring-1 focus:ring-gray-300  hover:bg-gray-200 border-none rounded-lg">
                                        Table
                                    </Link>
                                </li>
